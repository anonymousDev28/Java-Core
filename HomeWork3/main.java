...
public class main {
    ...
    public static void problem3() {
        ...
        else {            System.out.println("Sô tiền điện cần nộp là : "+(soDien*1200)+"vnđ");

            // hướng giải quyết 1:
            System.out.println("Sô tiền điện cần nộp là : "+(soDien*1200)+"vnđ");
            // hướng giải quyết 2:
            int soTienCanTra = (soDien-50)*1200 + 50*1000;
            System.out.println("Sô tiền điện cần nộp là : "+soTienCanTra+"vnđ");
