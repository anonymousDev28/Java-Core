...
public class ForgetPasswordView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Email Register: ");
        ...
        jLabel2.setText("Password Recover");
    ...
    private void btnCheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckActionPerformed
        ...
        String emailRegister = txtEmail.getText();
        if(!userModel.validateEmail(emailRegister)){
            showMessage("email is not valid!");
        }else if(userModel.checkEmail((ArrayList<User>) users, emailRegister)){
            showMessage("a new password was sent to your email");
        }else{
            showMessage("email doesnt exist!");
        }
